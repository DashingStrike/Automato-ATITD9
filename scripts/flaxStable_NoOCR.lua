...
imgHarvest = "harvestThis.png";
imgWeedAndWater = "weedWater.png";
imgWeed = "weedThis.png";
...
flaxStrains = { "Old Egypt", "Symphony Gold Ridge" };
flaxImages = { "oldEgypt.png", "symphonyGoldRidge.png" };
typeOfFlax = 1;
...
function promptFlaxNumbers()
  ...
  while not is_done do
	...
	typeOfFlax = readSetting("typeOfFlax",typeOfFlax);
	lsPrint(5, y, z, scale, scale, 0xFFFFFFff, "Flax Name:");
	typeOfFlax = lsDropdown("typeOfFlax", 100, y, 0, 185, typeOfFlax, flaxStrains);
	writeSetting("typeOfFlax",typeOfFlax);
	y = y + 32;

    num_loops = readSetting("num_loops",num_loops);
    lsPrint(5, y, z, scale, scale, 0xFFFFFFff, "Passes:");

    is_done, num_loops = lsEditBox("passes", 100, y, z, 50, 0, scale, scale,
    ...
    is_done, grid_w = lsEditBox("grid", 100, y, z, 50, 0, scale, scale,
                                0x000000ff, grid_w);
    ...
    if not is_plant then
      ...
      is_done, seeds_per_pass = lsEditBox("seedsper", 100, y, z, 50, 0,
    ...
    if is_plant then
      ...
      lsPrintWrapped(10, y, z+10, lsScreenX - 20, 0.7, 0.7, 0xD0D0D0ff,
                     ...
                     grid_w .. " grid of " .. flaxStrains[typeOfFlax] .. " Flax " .. num_loops ..
    ...
    y = y + 24;
      ...
      lsPrintWrapped(10, y, z+10, lsScreenX - 20, 0.7, 0.7, 0xD0D0D0ff,
                     ...
                     " grid of " .. flaxStrains[typeOfFlax] .. " Flax and harvest it " .. seeds_per_pass ..
...
function getPlantWindowPos()
  srReadScreen();
  local plantPos = srFindImage("flax/" .. flaxImages[typeOfFlax]);
  if plantPos then
...
function harvestAll(loop_count)
  ...
  if finish_up == 0 and tonumber(loop_count) ~= tonumber(num_loops) then
    ...
    if is_plant then
      ...
      local weeds = findAllImages("flax/" .. imgWeed);
      for i=#weeds, 1, -1 do
      ...
      local waters = findAllImages("flax/" .. imgWeedAndWater);
      for i=#waters, 1, -1 do
      ...
      local harvests = findAllImages("flax/" .. imgHarvest);
      ...
      if hsr then
	  srReadScreen()
		ripLoc = srFindImage("flax/" .. imgRipOut)
			if ripLoc then
			  clickAllImages("flax/" .. imgRipOut)  -- or clickAllImages(ripTextImage_or_whatever);
			end
      end
    else
      seedsList = findAllImages("flax/" .. imgSeeds);
