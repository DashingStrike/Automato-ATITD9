...
local essences = {
  ...
  ["Resin:Elephantia"] = 75,
  ["Resin:Feather Tree"] = 66,
  ["Resin:Feather Tree Sapling"] = 28,
  ["Resin:Feather Tree Youth"] = 64,
  ["Resin:Fern Palm"] = 27,
  ["Resin:Folded Birch"] = 20,
