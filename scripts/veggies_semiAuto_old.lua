...
function doit()
  ...
  thisSessionTimer = lsGetTimer();
	...
	refreshWindows(); -- The only purpose of this, here, is to refresh the plant window. In case we used all of our seeds last planting and the window is now blank.
